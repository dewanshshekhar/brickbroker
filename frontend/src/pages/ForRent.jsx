...
const allPropertiesForRent = [
  ...
  },
  {
    ...
    price: "₹80,000/month",
    title: "Luxury Villa with Pool for Rent",
  ...
  },
  {
    ...
    price: "₹1.5 Lac/month",
    title: "Penthouse with City Views for Rent",
  ...
  },
  {
    ...
    price: "₹60,000/month",
    title: "Family Home in Gated Community for Rent",
  ...
  },
  {
    ...
    price: "₹35,000/month",
    title: "Modern Apartment in Sector 49 for Rent",
  ...
  },
  {
    ...
    price: "₹1.2 Lac/month",
    title: "Spacious Villa in Sushant Lok for Rent",
...
const ForRent = () => {
  const [displayedProperties, setDisplayedProperties] = useState(allPropertiesForRent.slice(0, 6))
  ...
  const handleLoadMore = () => {
    ...
    setTimeout(() => {
      const nextBatch = allPropertiesForRent.slice(displayedProperties.length, displayedProperties.length + 3)
      ...
      <section className="bg-[#F9F8F3] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-[#484848] mb-6">Properties For Rent</h1>
            <p className="text-xl text-[#7A7A7A] max-w-3xl mx-auto">
              Find your ideal rental property in Gurugram with our extensive listings
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold text-[#484848]">{displayedProperties.length} Properties For Rent</h2>
          </div>
          ...
          <LoadMoreButton
            ...
            totalCount={allPropertiesForRent.length}
            itemType="properties"
          />
        </div>
      </section>
