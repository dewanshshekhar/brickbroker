...
const Properties = () => {
  const [displayedProperties, setDisplayedProperties] = useState(allProperties.slice(0, 6))
  ...
  const handleLoadMore = () => {
    ...
    setTimeout(() => {
      const nextBatch = allProperties.slice(displayedProperties.length, displayedProperties.length + 3)
      ...
      <section className="bg-[#F9F8F3] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-[#484848] mb-6">All Properties</h1>
      ...
      <section className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold text-[#484848]">{displayedProperties.length} Properties Found</h2>
          </div>
