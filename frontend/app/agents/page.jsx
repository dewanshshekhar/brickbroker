    ...
    <div className="bg-white text-gray-800">
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-white animate-fade-in-up">Our Expert Agents</h1>
        </div>
      </section>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/agents/all"
            className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 transition-colors duration-300 transform hover:scale-105 animate-bounce-in"
          >
            View All Agents
