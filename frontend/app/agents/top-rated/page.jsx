...
export default function TopRatedAgentsPage() {
  return (
    <div className="bg-white text-gray-800">
      ...
      <nav className="bg-gray-100 py-3 px-4 sm:px-6 lg:px-8">
        <ol className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <li>
            <span className="text-gray-700">Top Rated Agents</span>
          </li>
        </ol>
      </nav>
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-white animate-fade-in-up">Top Rated Agents</h1>
        </div>
      </section>
