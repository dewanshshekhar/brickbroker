...
import com.brickbroker.dto.AuthRequest;
import com.brickbroker.dto.AuthResponse;
import com.brickbroker.dto.ResetPasswordRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest authRequest) {
        try {
            ...
            User user = appUserDetailService.loadDomainUserByEmail(authRequest.getEmail());
            ...
            return ResponseEntity.ok()
                    ...
                    .body(AuthResponse.builder()
                            ...
                            .name(user.getName())
                            .token(jwtToken)
                            .role(user.getRole())  // return ADMIN / AGENT / USER
                            .build());
